...
/* 
glTFLoader.load("models/gltf-animations/eve__with-skin__idle__compressed.glb", (gltf) => {
...
async function loadEve() {
  const [idle, walk, run, jump, pose] = await Promise.all([
    glTFLoader.loadAsync("models/gltf-animations/eve__with-skin__idle__compressed.glb"),
    glTFLoader.loadAsync("models/gltf-animations/eve__no-skin__walking__compressed.glb"),
    glTFLoader.loadAsync("models/gltf-animations/eve__no-skin__running__compressed.glb"),
    glTFLoader.loadAsync("models/gltf-animations/eve__no-skin__jumping__compressed.glb"),
    glTFLoader.loadAsync("models/gltf-animations/eve__no-skin__standing-pose__compressed.glb"),
  ]);
