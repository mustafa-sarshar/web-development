...
/* 
new GLTFLoader().load("models/gltf-animations/eve$@walk.glb", (gltf) => {
...
async function loadEve() {
  ...
  const [eve, idle, run] = await Promise.all([
    loader.loadAsync("models/gltf-animations/eve$@walk.glb"),
    loader.loadAsync("models/gltf-animations/eve@idle.glb"),
    loader.loadAsync("models/gltf-animations/eve@run.glb"),
  ]);
