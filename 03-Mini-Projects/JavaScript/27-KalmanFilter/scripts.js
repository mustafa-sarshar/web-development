// Source: https://stackoverflow.com/questions/25744984/implement-a-kalman-filter-to-smooth-data-from-deviceorientation-api
// See also: https://www.npmjs.com/package/kalman-filter
var acc = {
  x: 0,
  y: 0,
  z: 0,
...
var getNewPos = window.setInterval(function () {
  ...
  $(".difference").html(
    " x:" +
      (acc.x - KM.x_k.elements[0]) +
      ", y:" +
      (acc.y - KM.x_k.elements[1]) +
      ", z:" +
      (acc.z - KM.x_k.elements[2])
  );
}, 100);
